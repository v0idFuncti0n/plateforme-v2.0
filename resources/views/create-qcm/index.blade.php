                                            ...
                                            <div class="input-group " id="dynamic_field">
                                                <tr>
                                                    ...
                                                    <div  style="margin-left: 6rem">
                                                        <input type="radio" id="text1" style="width: 8rem" name="textimg[]" value="1" class="sh" checked> <label class="radiolabel" for="text">text</label>
                                                        <input type="radio" id="img1" style="width: 8rem" name="textimg[]" value="1" class="sh">  <label class="radiolabel" for="img">image</label>
                                                    </div>
                                                    <input type="checkbox"
                                                    ...
                                                    <input  type="file" style="display: none;margin-left: 10rem; margin-top: -10.5rem; margin-bottom: 8rem;" id="imgg1" name="option_image[]" >
    ...
    $(document).ready(function () {
        $('#add').click(function () {
            ...
            if ($("#text"+(i-1)).is(':checked')) {
                $('#dynamic_field').append('<tr id="row' + i + '"><td><div style="margin-left: 6rem" >\n' +
                    '                                <input type="radio" id="text' + i + '" style="width: 8rem" name="textimg' + i + '[]"  value="' + i + '"  class="sh" checked> <label class="radiolabel" for="text' + i + '">text</label>\n' +
                    '                                <input type="radio" id="img' + i + '"  style="width: 8rem" name="textimg' + i + '[]"  value="' + i + '"  class="sh">  <label class="radiolabel" for="img' + i + '">image</label>\n' +
                    '                            </div><input type="checkbox" style="height: 17rem;width: 1.6rem;margin-right: 0.375rem"  name="point[]"  value="' + i + '" ><i type="button" name="remove" id="' + i + '" style="left: 37rem;top:-7.6rem" class="glyphicon glyphicon-trash btn_remove"></i> <textarea  id="textt' + i + '"  placeholder="" class="textarea--style-6 "name="option_text[]" style=" margin-bottom: 1.25rem;margin-left: -17px"></textarea><input type="hidden" name="hidden[]" value="' + i + '" ><input id="imgg' + i + '" style="display: none;margin-left: 10rem; margin-top: -10.5rem; margin-bottom: 8rem;"  type="file"  name="option_image[]" >  </td></tr>');
                ...
                $('#dynamic_field').append('<tr id="row' + i + '"><td><div style="margin-left: 6rem" >\n' +
                    ...
                    '                            </div><input type="checkbox" style="height: 17rem;width: 1.6rem;margin-right: 0.375rem"  name="point[]"  value="' + i + '" > <i type="button" name="remove" id="' + i + '" style="left: 37rem;top:-7.6rem" class="glyphicon glyphicon-trash btn_remove"></i> <textarea id="textt' + i + '"  style="display: none" placeholder="" class="textarea--style-6 "name="option_text[]" style=" margin-bottom: 1.25rem;margin-left: -17px"></textarea><input type="hidden" name="hidden[]" value="' + i + '" ><input id="imgg' + i + '" style="margin-left: 10rem; margin-top: -10.5rem; margin-bottom: 8rem;"  type="file"  name="option_image[]" > </td></tr>');
